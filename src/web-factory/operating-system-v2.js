...
export function runWebOperatingSystemV2(input = {}, options = {}) {
  ...
  const contentEvidence=createEvidenceSafeContentContract({mission,project_scope:mission.project_scope_key||mission.project_slug,claims:input.content_claims||input.claims||[],content:input.content||mission.existing_content||{},attempted_render_claim_ids:input.attempted_render_claim_ids||[]});

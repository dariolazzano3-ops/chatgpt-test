...
export function missionSupervisorManifest() { return { version: 'max-state-cas-1', mode: 'supervised_multi_factory_loop', supported_engines: ['web','automation','ai','business'], durable_persistence_hook: true, compare_and_swap_persistence: true, stale_writer_rejected_by_contract: true, web_dispatch_hook: true, web_observation_hook: true, explicit_adapter_approval_required: true, ai_injected_runner_required: true, automatic_multi_factory_execution: false, production_deploy: false }; }

...
function seededPortfolio(operatorId) {
  return {
    ...
    projects: [
      { customer_id: 'synthetic-customer-bakery', project_id: 'bakery-muller:universal-regression-v1', scope_key: 'synthetic-customer-bakery:bakery-muller:universal-regression-v1', name: 'Bäckerei Müller', industry: 'bakery', country: 'DE', language: 'de', state: 'READY', blocked: false, priority: 10, budget_cost_units: 0, capability_count: 5, mission_count: 0, delivery_count: 1, production_deploy: false },
      { customer_id: 'synthetic-customer-craft', project_id: 'handwerk-modernisierung:universal-v1', scope_key: 'synthetic-customer-craft:handwerk-modernisierung:universal-v1', name: 'Muster Handwerksbetrieb', industry: 'handwerk', country: 'DE', language: 'de', state: 'ACTIVE', blocked: false, priority: 20, budget_cost_units: 0, capability_count: 5, mission_count: 0, delivery_count: 0, production_deploy: false },
      { customer_id: 'synthetic-customer-service', project_id: 'service-studio:operator-v1', scope_key: 'synthetic-customer-service:service-studio:operator-v1', name: 'Synthetic Service Studio', industry: 'professional-services', country: 'DE', language: 'de', state: 'READY', blocked: false, priority: 30, budget_cost_units: 0, capability_count: 3, mission_count: 0, delivery_count: 0, production_deploy: false }
    ],
...
function createInitialRuntime(operatorId, at = null) {
  const created = createOperatorRuntime({ operator_id: operatorId, portfolio: seededPortfolio(operatorId), at: at || new Date().toISOString() });

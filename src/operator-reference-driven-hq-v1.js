...
body.reference-hq-v1 .side{padding:22px 10px 18px;background:linear-gradient(180deg,#071015 0%,#09141a 62%,#071015 100%);border-right:1px solid #1c2a32;box-shadow:18px 0 45px rgba(0,0,0,.12)}
...
.rf-hero:before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse at 80% 32%,rgba(213,174,84,.13),transparent 18%),linear-gradient(155deg,transparent 0 48%,rgba(22,41,48,.68) 48% 50%,transparent 50% 54%,rgba(12,27,34,.8) 54% 57%,transparent 57%),linear-gradient(180deg,rgba(8,19,25,.1),rgba(7,17,22,.88));opacity:.9;pointer-events:none}
...
.rf-kpi-label{font-size:11px;color:#c8d0d3}.rf-kpi-value{margin-top:2px;font-size:24px;line-height:1;font-weight:700;color:#fff}.rf-kpi-meta{margin-top:8px;font-size:9.5px;color:#73838b}
...
.rf-panel{min-width:0;border:1px solid var(--rf-line);border-radius:11px;background:linear-gradient(150deg,#0a161c,#0c1920);box-shadow:var(--rf-shadow);overflow:hidden}
...
.rf-ai-body{padding:14px}.rf-ai-message{padding:13px;border:1px solid #263943;border-radius:9px;background:#09151b;color:#d7dfe2;font-size:10.5px;line-height:1.55}.rf-ai-message strong{display:block;margin-bottom:6px;color:#fff;font-size:12px}.rf-ai-actions{display:flex;gap:7px;flex-wrap:wrap;margin-top:10px}.rf-ai-action{border:1px solid #2a3a43;border-radius:6px;background:#101e25;color:#b9c5ca;padding:7px 9px;font-size:9px}.rf-ai-input{margin-top:9px;width:100%;display:flex;align-items:center;justify-content:space-between;gap:8px;padding:9px 11px;border:1px solid #263943;border-radius:8px;background:#08141a;color:#74838b;font-size:10px}.rf-ai-new{border:1px solid rgba(213,174,84,.25);border-radius:7px;background:rgba(213,174,84,.08);color:#e8cc82;padding:7px 10px;font-size:9.5px}
.rf-portfolio-toolbar{display:flex;align-items:center;justify-content:space-between;gap:9px;padding:9px 14px;border-bottom:1px solid var(--rf-line-soft)}.rf-tabs{display:flex;gap:6px;flex-wrap:wrap}.rf-filter{border:1px solid #26343d;border-radius:6px;background:#0b171d;color:#8e9ba2;padding:6px 9px;font-size:9px}.rf-filter.active{border-color:rgba(213,174,84,.52);color:#e4c979;background:rgba(213,174,84,.08)}
.rf-project-row{min-height:60px;display:grid;grid-template-columns:38px minmax(0,1fr) auto;gap:10px;align-items:center;border-top:1px solid var(--rf-line-soft);padding:8px 0;cursor:pointer}.rf-project-row:first-child{border-top:0}.rf-project-row.selected{margin:4px -4px;padding-left:4px;padding-right:4px;border:1px solid rgba(213,174,84,.7);border-radius:8px;background:linear-gradient(90deg,rgba(213,174,84,.1),rgba(213,174,84,.025))}.rf-avatar{width:38px;height:38px;border-radius:7px;display:grid;place-items:center;background:linear-gradient(145deg,#1a2b34,#31414a);color:#e5ece8;font-size:10px;font-weight:700;letter-spacing:.05em}.rf-project-name{font-size:11px;font-weight:650;color:#f0f4f2}.rf-project-scope{margin-top:2px;color:#718088;font-size:8.6px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.rf-project-state{display:flex;gap:5px;flex-wrap:wrap;justify-content:flex-end}.rf-state{padding:4px 6px;border-radius:4px;border:1px solid #2b3a42;color:#9eabb1;font-size:8px;text-transform:uppercase}.rf-state.ready{border-color:rgba(78,212,146,.4);color:#5bdda0;background:rgba(78,212,146,.07)}.rf-state.attention{border-color:rgba(242,196,79,.4);color:#efcb58;background:rgba(242,196,79,.07)}.rf-state.blocked{border-color:rgba(255,106,97,.4);color:#ff8077;background:rgba(255,106,97,.07)}
.rf-selected-head{padding:12px 15px;display:flex;align-items:center;justify-content:space-between;gap:12px}.rf-selected-id{display:flex;gap:10px;align-items:center;min-width:0}.rf-selected-id .rf-avatar{width:44px;height:44px}.rf-selected-id h3{margin:0;color:#f4f7f5;font-size:15px}.rf-selected-id div:last-child{min-width:0}.rf-selected-tabs{display:flex;gap:4px;overflow:auto;padding:0 10px 7px;border-bottom:1px solid var(--rf-line-soft)}.rf-selected-tabs button{border:0;border-radius:6px;background:transparent;color:#91a0a7;padding:7px 10px;font-size:9px;white-space:nowrap}.rf-selected-tabs button.active{background:#17242b;color:#f4f7f5;box-shadow:inset 0 -2px 0 var(--rf-gold)}
.rf-selected-body{display:grid;grid-template-columns:1.15fr .85fr;gap:10px;padding:10px}.rf-subpanel{border:1px solid #22323b;border-radius:9px;background:#09151b;padding:12px;min-width:0}.rf-subpanel h4{margin:0 0 9px;color:#dce4e6;font-size:10px}.rf-status-line{display:flex;align-items:center;justify-content:space-between;gap:9px;font-size:9.5px;color:#91a0a7}.rf-progress{height:7px;margin:9px 0 6px;border-radius:99px;background:#17242b;overflow:hidden}.rf-progress span{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,#40d68b,#8be9ba)}.rf-next-action{border-color:rgba(213,174,84,.24);background:linear-gradient(135deg,rgba(213,174,84,.12),rgba(213,174,84,.04))}.rf-next-action strong{display:block;color:#f0e0ad;font-size:11px}.rf-next-action p{margin:5px 0 0;color:#9d936f;font-size:9px}.rf-mini-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-top:8px}.rf-mini-grid .rf-subpanel{padding:10px}.rf-mini-value{font-size:10px;color:#e8eeeb}.rf-mini-label{font-size:8.5px;color:#718088;margin-bottom:4px}.rf-activity{display:grid;gap:7px}.rf-activity div{display:grid;grid-template-columns:9px minmax(0,1fr) auto;gap:7px;align-items:center;color:#9eabb1;font-size:8.7px}.rf-activity i{width:5px;height:5px;border-radius:50%;background:var(--rf-gold)}.rf-empty{padding:18px;color:#73838b;font-size:10px;text-align:center}
body.reference-hq-v1 .error{background:#251416;border-color:#5f2b2f;color:#ffd7d4}
@media(max-width:1180px){body.reference-hq-v1 .app{grid-template-columns:190px minmax(0,1fr)}.rf-kpis{grid-template-columns:repeat(2,1fr)}.rf-grid-bottom{grid-template-columns:1fr}.rf-selected-body{grid-template-columns:1fr}}
@media(max-width:760px){body.reference-hq-v1 .app{display:block}body.reference-hq-v1 .rf-hq-nav{display:block!important;min-width:0;overflow:hidden}.rf-hq-nav-main{display:flex;gap:5px;overflow-x:auto;padding:2px 0 5px;scrollbar-width:none}.rf-hq-nav-main::-webkit-scrollbar{display:none}.rf-hq-nav-main button{width:auto;min-width:max-content;flex:0 0 auto;padding:8px 10px;min-height:36px}.rf-hq-system-toggle,.rf-hq-system,.rf-hq-nav-foot{display:none!important}body.reference-hq-v1 .side{position:static;height:auto;min-height:64px;padding:14px}.rf-toolbar{position:static;height:auto;min-height:54px;margin:0 -18px;padding:9px 12px;align-items:stretch}.rf-search{width:100%;max-width:none}.rf-toolbar-right{display:none}.rf-hero{padding:18px 2px 14px}.rf-hero h1{font-size:30px}.rf-hero-motto{display:none}.rf-kpis,.rf-grid-mid,.rf-grid-bottom{grid-template-columns:1fr}.rf-kpi{min-height:82px}.rf-attention-row{grid-template-columns:8px 92px minmax(0,1fr)}.rf-attention-time{display:none}.rf-project-row{grid-template-columns:34px minmax(0,1fr)}.rf-project-state{grid-column:2;justify-content:flex-start}.rf-selected-body{grid-template-columns:1fr}.rf-mini-grid{grid-template-columns:1fr}.rf-panel-head{align-items:flex-start}.rf-ai-actions{display:grid;grid-template-columns:1fr}.rf-ai-action{width:100%}}
</style>`;
...
(() => {
  ...
  function initials(project = {}) {
    return String(project.name || project.project_id || 'P').split(/\s+/).filter(Boolean).slice(0,2).map(x => x[0]).join('').toUpperCase();
  }
  ...
  function projectRow(p, selected) {
    ...
    return '<div class="rf-project-row '+(selected?'selected':'')+'" data-rf-project="'+safe(p.scope_key||'')+'"><div class="rf-avatar">'+safe(initials(p))+'</div><div><div class="rf-project-name">'+safe(p.name||p.project_id)+'</div><div class="rf-project-scope">'+safe(p.scope_key||'')+'</div></div><div class="rf-project-state"><span class="rf-state '+statusClass(life.health)+'">'+safe(stateLabel)+'</span>'+(preview.available?'<span class="rf-state ready">Preview verfügbar</span>':'')+(life.health==='NEEDS_ATTENTION'?'<span class="rf-state attention">Attention</span>':'')+'</div></div>';
  }
  ...
  function renderSelected(project) {
    ...
    return '<div class="rf-panel rf-selected"><div class="rf-selected-head"><div class="rf-selected-id"><div class="rf-avatar">'+safe(initials(project))+'</div><div><h3>'+safe(project.name||project.project_id)+'</h3><div class="rf-project-scope">'+safe(project.scope_key||'')+'</div></div></div><button class="rf-link" data-rf-open-project>Projekt öffnen →</button></div><div class="rf-selected-tabs">'+[['overview','Übersicht'],['sources','Quellen'],['knowledge','Projektwissen'],['implementation','Umsetzung'],['preview','Preview'],['approvals','Prüfungen'],['activity','Aktivität']].map(([id,label],i)=>'<button class="'+(i===0?'active':'')+'" data-rf-tab="'+id+'">'+label+'</button>').join('')+'</div><div class="rf-selected-body"><div><div class="rf-subpanel"><h4>Projektstatus</h4><div class="rf-status-line"><span class="rf-state '+statusClass(life.health)+'">'+safe(life.phase==='BUILD'?'In Umsetzung':life.phase)+'</span><strong>'+pct+' %</strong></div><div class="rf-progress"><span style="width:'+Math.max(0,Math.min(100,pct))+'%"></span></div><div class="rf-project-scope">'+safe(life.environment)+' · '+safe(life.health==='NEEDS_ATTENTION'?'Benötigt Aufmerksamkeit':life.health)+'</div></div><div class="rf-mini-grid"><div class="rf-subpanel"><div class="rf-mini-label">Cost & Safety</div><div class="rf-mini-value">'+safe(money(currentCost))+'</div><div class="rf-project-scope">Production locked</div></div><div class="rf-subpanel"><div class="rf-mini-label">Preview Access</div><div class="rf-mini-value">'+safe(preview.available?'Preview verfügbar':'Noch keine Preview')+'</div>'+(preview.available?'<button class="rf-link" data-rf-tab="preview">Preview öffnen →</button>':'')+'</div><div class="rf-subpanel"><div class="rf-mini-label">Projektwissen</div><div class="rf-mini-value">'+safe(c.knowledge_status==='APPROVED'?'Bereit':c.knowledge_attention?c.knowledge_attention+' zu prüfen':'Noch nicht bereit')+'</div><div class="rf-project-scope">'+safe(c.fact_count||0)+' Fakten · '+safe(c.source_count||0)+' Quellen</div></div></div></div><div><div class="rf-subpanel rf-next-action"><h4>Nächste Aktion</h4><strong>'+safe(action.label)+'</strong><p>Deterministisch aus bestehender Ferrari Project Truth.</p><button class="rf-link" data-rf-tab="'+safe(action.tab)+'">Jetzt öffnen →</button></div><div class="rf-subpanel" style="margin-top:8px"><h4>Letzte Aktivitäten</h4>'+activityMarkup(project,detail)+'</div></div></div></div>';
  }
  ...
  function renderReferenceHq() {
    ...
    const list = projects();
    const selected = selectedProject();
    const filtered = list.filter(p => !state.referenceHqQuery || [p.name,p.project_id,p.customer_id,p.scope_key].some(v => String(v||'').toLowerCase().includes(String(state.referenceHqQuery).toLowerCase()))).slice(0,5);

...
const INLINE_PREVIEW_MIME=['image/png','image/jpeg','image/webp','image/gif','application/pdf'];
const canPreview=s=>INLINE_PREVIEW_MIME.includes(String(s?.mime_type||'').toLowerCase());

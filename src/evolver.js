...
export async function evolveProject(request, env, body = {}) {
  ...
  if (reuseBranch && !branch.startsWith("factory/")) {
    return { error: "ACTIVE_EDIT_BRANCH_MUST_BE_FACTORY_BRANCH", status: 400 };
  }

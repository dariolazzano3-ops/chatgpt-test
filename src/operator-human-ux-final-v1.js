...
(() => {
  ...
  function finalPolish(id){if(id==='projects'){wrapProjectCreate();clearStaleProjectPriority()}if(id==='providers')humanizeProviderLabels();if(id==='audit')humanize(document.getElementById('audit'));if(state?.detail&&document.getElementById('project-detail')?.children.length)humanProjectDetail(state.detail)}

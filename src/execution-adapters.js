...
const ADAPTERS = Object.freeze({
  ...
  automation: Object.freeze({ id: "automation-factory-v1", engine: "automation", mode: "provider_routed", provider_policy: "riosystems.automation-provider-strategy.v1", default_runtime_provider: "activepieces-cloud-free", fallback_runtime_provider: "make-core", available: true, automatic_execution: false, external_side_effects: "supervised_only", production_deploy: false, accepts: ["automation", "lead_flow", "workflow", "api_flow", "webhook_flow"] }),

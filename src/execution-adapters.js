...
const ADAPTERS = Object.freeze({
  web: Object.freeze({ id: "web-factory-v1", engine: "web", mode: "provider_routed", provider_policy: "riosystems.web-provider-strategy.v1", default_build_provider: "riosystems-native-web", visual_specialist_provider: "framer", premium_visual_mode: "framer-design-native-cloudflare", framer_hosting_default: false, default_host_provider: "cloudflare-workers-free", available: true, automatic_execution: false, production_deploy: false, accepts: ["website", "web_edit", "web_build"] }),

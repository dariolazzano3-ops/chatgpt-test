...
.project-preview-access-v1{margin-top:14px}.project-preview-head{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;flex-wrap:wrap}.project-preview-meta{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:10px}.project-preview-kv{border:1px solid var(--soft);border-radius:10px;padding:9px;min-width:0;overflow-wrap:anywhere}.project-preview-kv b{display:block;font-size:11px;color:var(--muted);margin-bottom:3px}.project-preview-final-action{margin-top:10px;padding:10px;border:1px solid var(--line);border-radius:10px;background:var(--soft)}@media(max-width:760px){.project-preview-meta{grid-template-columns:1fr}.project-preview-access-v1 .btn,.project-preview-final-action .btn{width:100%;min-height:46px}}

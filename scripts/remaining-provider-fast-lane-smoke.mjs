...
assert.equal(activepiecesMatrix.activation, 'historical_read_only_connection_evidence');
...
assert.equal(activepiecesMatrix.current_runtime_verified, false);
assert.equal(activepiecesMatrix.runtime_truth.actual_executor_availability, 'NOT_CURRENTLY_VERIFIED');
...
assert.equal(webflowMatrix.activation, 'historical_read_only_connection_evidence');
...
assert.equal(webflowMatrix.current_runtime_verified, false);
assert.equal(webflowMatrix.runtime_truth.actual_executor_availability, 'NOT_CURRENTLY_VERIFIED');

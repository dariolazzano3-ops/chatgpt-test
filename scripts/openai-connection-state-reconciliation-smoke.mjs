...
assert.equal(openAiMatrix.activation, 'historical_connected_staging_evidence_budget_gate');
assert.equal(openAiMatrix.current_runtime_verified, false);
assert.equal(openAiMatrix.runtime_truth.actual_executor_availability, 'NOT_CURRENTLY_VERIFIED');

...
assert.equal(cloudflareAi.blockers.some((item) => item.code === 'PROVIDER_CONNECTION_REQUIRED'), true);
...
assert.deepEqual(manifest.connection_required, ['cloudflare-workers-free','cloudflare-workers-ai-free']);

...
assert.equal(snapshot.sample.jobs_total, 2);
...
console.log(JSON.stringify({ ok: true, factory_version: snapshot.factory_version, jobs: snapshot.sample.jobs_total, repair_recovery_rate: snapshot.sample.auto_repair_recovery_rate_pct }, null, 2));
